...
$page_title = 'UniClubs - Administration';
                                ...
                                <div class="card admin-club-card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
                                    <div class="card-header border-0 py-3" style="background: <?= htmlspecialchars($club['couleur_gradient']) ?>">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="badge" style="background:rgba(59,130,246,0.15);color:#60A5FA;"><?= htmlspecialchars(ucfirst($club['categorie'])) ?></div>
                                            <div class="dropdown">
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="row text-center g-2 mt-auto">
                                            <div class="col-4">
                                                <div class="p-2 border rounded-3" style="background:var(--surface2);">
                                                    <div class="fw-bold fs-5"><?= $stats['membres'] ?></div>
                                                    <div class="small text-muted">Membres</div>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="p-2 border rounded-3 <?= $stats['attente'] > 0 ? '' : '' ?>" style="background:<?= $stats['attente'] > 0 ? 'rgba(239,68,68,0.1)' : 'var(--surface2)' ?>;">
                                                    <div class="fw-bold fs-5 <?= $stats['attente'] > 0 ? 'text-danger' : '' ?>"><?= $stats['attente'] ?></div>
                                                    <div class="small <?= $stats['attente'] > 0 ? 'text-danger' : 'text-muted' ?>">Demandes</div>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="p-2 border rounded-3" style="background:var(--surface2);">
                                                    <div class="fw-bold fs-5"><?= $stats['events'] ?></div>
                                    ...
                                    <tbody>
                                        <?php foreach ($pending_requests as $req): ?>
                                            <tr>
                                                ...
                                                <td><span class="badge" style="background:rgba(59,130,246,0.1);color:#60A5FA;border:1px solid rgba(59,130,246,0.2);"><?= htmlspecialchars($req['club_nom']) ?></span></td>
                                    ...
                                    <tbody>
                                        <?php foreach ($upcoming_events as $evt): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="badge" style="background:rgba(59,130,246,0.1);color:#60A5FA;border:1px solid rgba(59,130,246,0.2);"><?= htmlspecialchars($evt['club_nom']) ?></span></td>
                                                <td>
